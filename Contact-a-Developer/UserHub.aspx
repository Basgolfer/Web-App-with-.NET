        ...
        <div class="jumbotron">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <a href="Inbox.aspx">&nbsp;Messages</a>
                </div>
                <div class="col-md-3 col-md-offset-1">
                    <div class="glyphicon glyphicon-plus"></div>
                    <a href="WebsiteRequest.aspx">&nbsp;Submit a new request</a>
                </div>
                <div class="col-md-3 col-md-offset-1">
                    <div class="glyphicon glyphicon-list-alt"></div>
                    <a href="SubmissionStatus.aspx">&nbsp; Your accepted jobs </a>
                </div>
            </div>
        </div>
    </asp:Panel>
    <asp:Panel ID="devdash" runat="server">
        <div class="jumbotron">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-md-offset-1">
                    <div class="glyphicon glyphicon-list-alt"></div>
                    <a href="Unassigned Web Request Table.aspx">&nbsp;Unassigned Jobs</a>
                </div>
                    
                <div class="col-md-3 col-md-offset-1">
                    <div class="glyphicon glyphicon-list"></div>
                    <a href="Your Job Table.aspx">&nbsp;My jobs</a>
                </div>
            </div>
            <br />
            <div class="row">
                <div class="col-md-4">
                    ...
                    <a href="EditDevProfile.aspx">Edit Your Developer Profile</a>
                </div>
            </div>
        </div>
    </asp:Panel>
