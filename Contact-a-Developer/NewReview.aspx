<%@ Page Title="Submit a review" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="NewReview.aspx.cs" Inherits="NewReview" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="form-group">
        ...
        <div class="col-md-12">    
            <asp:RadioButtonList ID="lstRating" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="lstRating_SelectedIndexChanged">
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <br />
            <asp:Button ID="btnRatingSubmit" runat="server" Text="Submit" OnClick="btnRatingSubmit_Click" />
        </div>
